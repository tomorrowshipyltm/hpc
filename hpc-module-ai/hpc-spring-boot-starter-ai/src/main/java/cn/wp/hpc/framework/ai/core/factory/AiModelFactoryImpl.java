package cn.wp.hpc.framework.ai.core.factory;
...
import cn.wp.hpc.framework.ai.config.HpcAiAutoConfiguration;
import cn.wp.hpc.framework.ai.config.HpcAiProperties;
...
import cn.wp.hpc.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            HpcAiProperties.MidjourneyProperties properties = SpringUtil.getBean(HpcAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link HpcAiAutoConfiguration#deepSeekChatModel(HpcAiProperties)}
     */
    ...
    /**
     * 可参考 {@link HpcAiAutoConfiguration#xingHuoChatClient(HpcAiProperties)}
     */
