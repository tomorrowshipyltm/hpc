package cn.wp.hpc.module.bpm.service.task;
...
import cn.wp.hpc.framework.common.util.object.ObjectUtils;
import cn.wp.hpc.framework.common.util.object.PageUtils;
import cn.wp.hpc.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.wp.hpc.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.wp.hpc.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.wp.hpc.module.bpm.controller.admin.task.vo.instance.*;
import cn.wp.hpc.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.wp.hpc.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.wp.hpc.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.wp.hpc.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.wp.hpc.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.wp.hpc.module.bpm.enums.ErrorCodeConstants;
import cn.wp.hpc.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.wp.hpc.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.wp.hpc.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.wp.hpc.module.bpm.enums.task.BpmReasonEnum;
import cn.wp.hpc.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.wp.hpc.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.wp.hpc.module.bpm.framework.flowable.core.candidate.strategy.dept.BpmTaskCandidateStartUserSelectStrategy;
import cn.wp.hpc.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.wp.hpc.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.wp.hpc.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.wp.hpc.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.wp.hpc.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.wp.hpc.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.wp.hpc.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.wp.hpc.module.bpm.service.message.BpmMessageService;
...
import static cn.wp.hpc.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.wp.hpc.module.bpm.enums.ErrorCodeConstants.*;
import static cn.wp.hpc.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
