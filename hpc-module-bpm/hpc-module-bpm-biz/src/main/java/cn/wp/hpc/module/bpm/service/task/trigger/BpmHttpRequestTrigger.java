package cn.wp.hpc.module.bpm.service.task.trigger;

import cn.wp.hpc.framework.common.util.json.JsonUtils;
import cn.wp.hpc.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO.TriggerSetting.HttpRequestTriggerSetting;
import cn.wp.hpc.module.bpm.enums.definition.BpmTriggerTypeEnum;
...
import static cn.wp.hpc.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
