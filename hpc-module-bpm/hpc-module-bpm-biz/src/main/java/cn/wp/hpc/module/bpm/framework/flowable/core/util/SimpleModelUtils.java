package cn.wp.hpc.module.bpm.framework.flowable.core.util;
...
import cn.wp.hpc.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO.ConditionGroups;
...
import cn.wp.hpc.module.bpm.framework.flowable.core.listener.BpmCopyTaskDelegate;
import cn.wp.hpc.module.bpm.framework.flowable.core.listener.BpmTriggerTaskDelegate;
...
import static cn.wp.hpc.module.bpm.framework.flowable.core.enums.BpmnModelConstants.*;
import static cn.wp.hpc.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
import static cn.wp.hpc.module.bpm.service.task.listener.BpmUserTaskListener.DELEGATE_EXPRESSION;
