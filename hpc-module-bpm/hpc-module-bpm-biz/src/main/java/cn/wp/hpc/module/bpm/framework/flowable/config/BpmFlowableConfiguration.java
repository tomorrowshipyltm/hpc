package cn.wp.hpc.module.bpm.framework.flowable.config;

import cn.hutool.core.collection.ListUtil;
import cn.wp.hpc.module.bpm.framework.flowable.core.behavior.BpmActivityBehaviorFactory;
...
public class BpmFlowableConfiguration {
    ...
    @PostConstruct
    public void init() {
        System.out.println("bpmFlowableConfiguration has been loaded");
    }
