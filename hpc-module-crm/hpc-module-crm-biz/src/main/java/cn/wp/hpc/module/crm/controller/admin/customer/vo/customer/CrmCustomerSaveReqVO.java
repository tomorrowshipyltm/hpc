package cn.wp.hpc.module.crm.controller.admin.customer.vo.customer;

import cn.wp.hpc.framework.common.validation.InEnum;
import cn.wp.hpc.framework.common.validation.Mobile;
import cn.wp.hpc.framework.common.validation.Telephone;
import cn.wp.hpc.framework.excel.core.annotations.DictFormat;
import cn.wp.hpc.module.crm.enums.customer.CrmCustomerLevelEnum;
import cn.wp.hpc.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import cn.wp.hpc.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import cn.wp.hpc.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import cn.wp.hpc.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static cn.wp.hpc.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
