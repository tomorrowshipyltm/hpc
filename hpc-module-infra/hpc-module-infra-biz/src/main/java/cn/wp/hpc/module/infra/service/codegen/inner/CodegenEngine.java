package cn.wp.hpc.module.infra.service.codegen.inner;
...
import cn.wp.hpc.framework.apilog.core.annotation.ApiAccessLog;
import cn.wp.hpc.framework.apilog.core.enums.OperateTypeEnum;
...
import cn.wp.hpc.framework.excel.core.annotations.DictFormat;
import cn.wp.hpc.framework.excel.core.convert.DictConvert;
import cn.wp.hpc.framework.excel.core.util.ExcelUtils;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "hpc-module-${table.moduleName}/" + // 顶级模块
                "hpc-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "hpc-module-${table.moduleName}/" + // 顶级模块
                "hpc-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "hpc-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "hpc-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
