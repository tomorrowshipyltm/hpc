package cn.wp.hpc.module.infra.controller.admin.codegen;
...
import cn.wp.hpc.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.wp.hpc.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.wp.hpc.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.wp.hpc.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.wp.hpc.module.infra.convert.codegen.CodegenConvert;
...
import cn.wp.hpc.module.infra.service.codegen.CodegenService;
...
import static cn.wp.hpc.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "hpc"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "示例")
    })
