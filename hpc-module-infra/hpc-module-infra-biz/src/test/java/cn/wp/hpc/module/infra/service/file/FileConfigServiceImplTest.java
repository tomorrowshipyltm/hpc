package cn.wp.hpc.module.infra.service.file;
...
import cn.wp.hpc.module.infra.framework.file.core.enums.FileStorageEnum;
import cn.wp.hpc.framework.test.core.ut.BaseDbUnitTest;
import cn.wp.hpc.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import cn.wp.hpc.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import cn.wp.hpc.module.infra.dal.dataobject.file.FileConfigDO;
import cn.wp.hpc.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static cn.wp.hpc.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.wp.hpc.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("示例源码")
