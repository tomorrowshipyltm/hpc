package cn.wp.hpc.module.infra.service.logger;
...
import cn.wp.hpc.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.wp.hpc.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.wp.hpc.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.wp.hpc.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.wp.hpc.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.wp.hpc.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("hpc-test");
