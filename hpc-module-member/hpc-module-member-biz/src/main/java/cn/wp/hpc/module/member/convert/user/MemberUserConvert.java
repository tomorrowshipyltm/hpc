package cn.wp.hpc.module.member.convert.user;

import cn.wp.hpc.framework.common.pojo.PageResult;
import cn.wp.hpc.module.member.api.user.dto.MemberUserRespDTO;
import cn.wp.hpc.module.member.controller.admin.user.vo.MemberUserRespVO;
import cn.wp.hpc.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import cn.wp.hpc.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
import cn.wp.hpc.module.member.convert.address.AddressConvert;
