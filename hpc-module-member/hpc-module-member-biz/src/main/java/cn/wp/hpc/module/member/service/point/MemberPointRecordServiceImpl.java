package cn.wp.hpc.module.member.service.point;
...
import cn.wp.hpc.module.member.dal.mysql.point.MemberPointRecordMapper;
...
import static cn.wp.hpc.module.member.enums.ErrorCodeConstants.USER_POINT_NOT_ENOUGH;
