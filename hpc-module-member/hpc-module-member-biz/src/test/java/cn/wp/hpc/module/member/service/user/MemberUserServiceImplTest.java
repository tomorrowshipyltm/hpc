...
import cn.wp.hpc.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import cn.wp.hpc.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, HpcRedisAutoConfiguration.class})
