package cn.wp.hpc.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${hpc.websocket.sender-rocketmq.topic}",
        consumerGroup = "${hpc.websocket.sender-rocketmq.consumer-group}",
