package cn.wp.hpc.framework.tracer.config;

import cn.wp.hpc.framework.common.enums.WebFilterOrderEnum;
import cn.wp.hpc.framework.tracer.core.aop.BizTraceAspect;
import cn.wp.hpc.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "hpc.tracer", value = "enable", matchIfMissing = true)
public class HpcTracerAutoConfiguration {
