package cn.wp.hpc.framework.desensitize.core;

import cn.wp.hpc.framework.common.util.json.JsonUtils;
import cn.wp.hpc.framework.desensitize.core.annotation.Address;
import cn.wp.hpc.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.wp.hpc.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.wp.hpc.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("示例源码");
        ...
        desensitizeDemo.setRegex("你好，我是示例源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("示例源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "示例源码", replacer = "*")
