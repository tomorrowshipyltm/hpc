package cn.wp.hpc.framework.ratelimiter.config;

import cn.wp.hpc.framework.ratelimiter.core.aop.RateLimiterAspect;
import cn.wp.hpc.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import cn.wp.hpc.framework.ratelimiter.core.keyresolver.impl.*;
...
public class HpcRateLimiterConfiguration {
