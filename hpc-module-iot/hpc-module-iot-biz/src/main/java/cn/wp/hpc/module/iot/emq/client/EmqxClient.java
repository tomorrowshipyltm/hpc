package cn.wp.hpc.module.iot.emq.client;

import cn.wp.hpc.module.iot.emq.callback.EmqxCallback;
import cn.wp.hpc.module.iot.emq.config.MqttConfig;
import lombok.Data;
...
public class EmqxClient {
    ...
    private void createMqttClient() {
        try {
            mqttClient = new MqttClient(mqttConfig.getHostUrl(), "hpc" + mqttConfig.getClientId(), new MemoryPersistence());
