...
import cn.wp.hpc.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.wp.hpc.framework.common.pojo.PageResult;
import cn.wp.hpc.framework.common.util.date.DateUtils;
import cn.wp.hpc.framework.common.util.object.BeanUtils;
import cn.wp.hpc.framework.security.core.LoginUser;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    /**
     * 加载用户信息，方便 {@link cn.wp.hpc.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId 用户编号
     * @param userType 用户类型
     * @return 用户信息
