...
import cn.wp.hpc.framework.common.util.cache.CacheUtils;
import cn.wp.hpc.framework.common.util.http.HttpUtils;
import cn.wp.hpc.framework.common.util.object.BeanUtils;
import cn.wp.hpc.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.wp.hpc.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.wp.hpc.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.wp.hpc.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.wp.hpc.module.system.dal.dataobject.social.SocialClientDO;
import cn.wp.hpc.module.system.dal.mysql.social.SocialClientMapper;
import cn.wp.hpc.module.system.dal.redis.RedisKeyConstants;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${hpc.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${hpc.wxa-subscribe-message.miniprogram-state:formal}")
