package cn.wp.hpc.module.system.service.tenant;

import cn.wp.hpc.framework.common.enums.CommonStatusEnum;
import cn.wp.hpc.framework.common.pojo.PageResult;
import cn.wp.hpc.framework.tenant.config.TenantProperties;
import cn.wp.hpc.framework.tenant.core.context.TenantContextHolder;
import cn.wp.hpc.framework.test.core.ut.BaseDbUnitTest;
import cn.wp.hpc.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.wp.hpc.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.wp.hpc.module.system.dal.dataobject.permission.MenuDO;
import cn.wp.hpc.module.system.dal.dataobject.permission.RoleDO;
import cn.wp.hpc.module.system.dal.dataobject.tenant.TenantDO;
import cn.wp.hpc.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.wp.hpc.module.system.dal.mysql.tenant.TenantMapper;
import cn.wp.hpc.module.system.enums.permission.RoleCodeEnum;
import cn.wp.hpc.module.system.enums.permission.RoleTypeEnum;
import cn.wp.hpc.module.system.service.permission.MenuService;
import cn.wp.hpc.module.system.service.permission.PermissionService;
import cn.wp.hpc.module.system.service.permission.RoleService;
import cn.wp.hpc.module.system.service.tenant.handler.TenantInfoHandler;
import cn.wp.hpc.module.system.service.tenant.handler.TenantMenuHandler;
import cn.wp.hpc.module.system.service.user.AdminUserService;
...
import static cn.wp.hpc.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("示例", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("示例"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("示例");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
