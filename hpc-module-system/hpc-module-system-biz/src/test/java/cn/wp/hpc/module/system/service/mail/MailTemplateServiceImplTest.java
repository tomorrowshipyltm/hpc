package cn.wp.hpc.module.system.service.mail;

import cn.wp.hpc.framework.common.enums.CommonStatusEnum;
import cn.wp.hpc.framework.common.pojo.PageResult;
import cn.wp.hpc.framework.test.core.ut.BaseDbUnitTest;
import cn.wp.hpc.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
...
import cn.wp.hpc.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.wp.hpc.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("示例")));
        // 测试 code 不匹配
