package cn.wp.hpc.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.wp.hpc.framework.common.enums.CommonStatusEnum;
import cn.wp.hpc.framework.common.exception.ServiceException;
import cn.wp.hpc.framework.common.pojo.PageResult;
import cn.wp.hpc.framework.common.util.collection.ArrayUtils;
import cn.wp.hpc.framework.common.util.collection.CollectionUtils;
import cn.wp.hpc.framework.test.core.ut.BaseDbUnitTest;
import cn.wp.hpc.module.infra.api.config.ConfigApi;
import cn.wp.hpc.module.infra.api.file.FileApi;
import cn.wp.hpc.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.wp.hpc.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.wp.hpc.module.system.controller.admin.user.vo.user.*;
import cn.wp.hpc.module.system.dal.dataobject.dept.DeptDO;
import cn.wp.hpc.module.system.dal.dataobject.dept.PostDO;
import cn.wp.hpc.module.system.dal.dataobject.dept.UserPostDO;
import cn.wp.hpc.module.system.dal.dataobject.tenant.TenantDO;
import cn.wp.hpc.module.system.dal.dataobject.user.AdminUserDO;
import cn.wp.hpc.module.system.dal.mysql.dept.UserPostMapper;
import cn.wp.hpc.module.system.dal.mysql.user.AdminUserMapper;
import cn.wp.hpc.module.system.enums.common.SexEnum;
import cn.wp.hpc.module.system.service.dept.DeptService;
import cn.wp.hpc.module.system.service.dept.PostService;
import cn.wp.hpc.module.system.service.permission.PermissionService;
import cn.wp.hpc.module.system.service.tenant.TenantService;
...
import static cn.wp.hpc.framework.common.util.collection.SetUtils.asSet;
import static cn.wp.hpc.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.wp.hpc.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.wp.hpc.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.wp.hpc.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.wp.hpc.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.wp.hpc.framework.test.core.util.RandomUtils.*;
import static cn.wp.hpc.module.system.enums.ErrorCodeConstants.*;
import static cn.wp.hpc.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("hpcyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("hpcyuanma");
        ...
        assertEquals("hpcyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("hpcyuanma"))).thenReturn("java");
