package cn.wp.hpc.module.mp.service.account;
...
import cn.wp.hpc.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.wp.hpc.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.wp.hpc.module.mp.convert.account.MpAccountConvert;
import cn.wp.hpc.module.mp.dal.dataobject.account.MpAccountDO;
import cn.wp.hpc.module.mp.dal.mysql.account.MpAccountMapper;
import cn.wp.hpc.module.mp.enums.ErrorCodeConstants;
...
import static cn.wp.hpc.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 hpc-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
