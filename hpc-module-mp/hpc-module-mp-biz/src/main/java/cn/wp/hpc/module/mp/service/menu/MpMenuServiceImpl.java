package cn.wp.hpc.module.mp.service.menu;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.wp.hpc.module.mp.controller.admin.menu.vo.MpMenuSaveReqVO;
import cn.wp.hpc.module.mp.convert.menu.MpMenuConvert;
import cn.wp.hpc.module.mp.dal.dataobject.account.MpAccountDO;
import cn.wp.hpc.module.mp.dal.dataobject.menu.MpMenuDO;
import cn.wp.hpc.module.mp.dal.mysql.menu.MpMenuMapper;
import cn.wp.hpc.module.mp.framework.mp.core.MpServiceFactory;
import cn.wp.hpc.module.mp.framework.mp.core.util.MpUtils;
...
import static cn.wp.hpc.module.mp.enums.ErrorCodeConstants.MENU_DELETE_FAIL;
import static cn.wp.hpc.module.mp.enums.ErrorCodeConstants.MENU_SAVE_FAIL;
