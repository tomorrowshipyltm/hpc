package cn.wp.hpc.module.mp.service.message;
...
import cn.wp.hpc.module.mp.dal.mysql.message.MpMessageMapper;
import cn.wp.hpc.module.mp.enums.message.MpMessageSendFromEnum;
...
import cn.wp.hpc.module.mp.service.material.MpMaterialService;
import cn.wp.hpc.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.wp.hpc.module.mp.service.user.MpUserService;
...
import static cn.wp.hpc.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
