package cn.wp.hpc.module.erp.controller.admin.stock.vo.out;
...
import static cn.wp.hpc.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "示例")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人", example = "示例")
    private String creator;
    @Schema(description = "创建人名称", example = "示例")
