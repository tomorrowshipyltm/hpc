package cn.wp.hpc.module.product.service.category;

import cn.wp.hpc.framework.common.enums.CommonStatusEnum;
import cn.wp.hpc.framework.test.core.ut.BaseDbUnitTest;
import cn.wp.hpc.module.product.controller.admin.category.vo.ProductCategoryListReqVO;
import cn.wp.hpc.module.product.controller.admin.category.vo.ProductCategorySaveReqVO;
import cn.wp.hpc.module.product.dal.dataobject.category.ProductCategoryDO;
import cn.wp.hpc.module.product.dal.mysql.category.ProductCategoryMapper;
...
import static cn.wp.hpc.module.product.dal.dataobject.category.ProductCategoryDO.PARENT_ID_NULL;
import static cn.wp.hpc.module.product.enums.ErrorCodeConstants.CATEGORY_NOT_EXISTS;
