...
import cn.wp.hpc.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import cn.wp.hpc.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import cn.wp.hpc.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
...
import cn.wp.hpc.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import cn.wp.hpc.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static cn.wp.hpc.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.wp.hpc.framework.common.util.collection.CollectionUtils.getMinValue;
import static cn.wp.hpc.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static cn.wp.hpc.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
