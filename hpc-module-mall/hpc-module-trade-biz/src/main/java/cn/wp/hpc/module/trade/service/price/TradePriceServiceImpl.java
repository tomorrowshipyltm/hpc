package cn.wp.hpc.module.trade.service.price;

import cn.hutool.core.collection.CollUtil;
import cn.wp.hpc.framework.common.util.object.BeanUtils;
import cn.wp.hpc.module.member.api.level.dto.MemberLevelRespDTO;
...
import cn.wp.hpc.module.promotion.api.discount.DiscountActivityApi;
import cn.wp.hpc.module.promotion.api.discount.dto.DiscountProductRespDTO;
import cn.wp.hpc.module.promotion.api.reward.RewardActivityApi;
import cn.wp.hpc.module.promotion.api.reward.dto.RewardActivityMatchRespDTO;
import cn.wp.hpc.module.promotion.enums.common.PromotionTypeEnum;
import cn.wp.hpc.module.trade.controller.app.order.vo.AppTradeProductSettlementRespVO;
...
import cn.wp.hpc.module.trade.service.price.calculator.TradeDiscountActivityPriceCalculator;
...
import static cn.wp.hpc.module.product.enums.ErrorCodeConstants.SKU_STOCK_NOT_ENOUGH;
import static cn.wp.hpc.module.trade.enums.ErrorCodeConstants.PRICE_CALCULATE_PAY_PRICE_ILLEGAL;
