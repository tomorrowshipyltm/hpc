package cn.wp.hpc.module.promotion.service.kefu;
...
import cn.wp.hpc.module.infra.api.websocket.WebSocketSenderApi;
import cn.wp.hpc.module.member.api.user.MemberUserApi;
import cn.wp.hpc.module.promotion.controller.admin.kefu.vo.message.KeFuMessageListReqVO;
import cn.wp.hpc.module.promotion.controller.admin.kefu.vo.message.KeFuMessageSendReqVO;
import cn.wp.hpc.module.promotion.controller.app.kefu.vo.message.AppKeFuMessagePageReqVO;
import cn.wp.hpc.module.promotion.controller.app.kefu.vo.message.AppKeFuMessageSendReqVO;
import cn.wp.hpc.module.promotion.dal.dataobject.kefu.KeFuConversationDO;
import cn.wp.hpc.module.promotion.dal.dataobject.kefu.KeFuMessageDO;
import cn.wp.hpc.module.promotion.dal.mysql.kefu.KeFuMessageMapper;
...
import static cn.wp.hpc.module.promotion.enums.ErrorCodeConstants.KEFU_CONVERSATION_NOT_EXISTS;
import static cn.wp.hpc.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_ADMIN_READ;
import static cn.wp.hpc.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_TYPE;
