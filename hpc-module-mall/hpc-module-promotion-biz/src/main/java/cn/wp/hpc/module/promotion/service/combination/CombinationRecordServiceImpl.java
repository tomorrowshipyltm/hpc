package cn.wp.hpc.module.promotion.service.combination;
...
import cn.wp.hpc.module.promotion.controller.admin.combination.vo.recrod.CombinationRecordReqPageVO;
import cn.wp.hpc.module.promotion.controller.app.combination.vo.record.AppCombinationRecordPageReqVO;
...
import cn.wp.hpc.module.promotion.dal.mysql.combination.CombinationRecordMapper;
...
import cn.wp.hpc.module.trade.api.order.TradeOrderApi;
import cn.wp.hpc.module.trade.enums.order.TradeOrderCancelTypeEnum;
...
import static cn.wp.hpc.framework.common.util.date.LocalDateTimeUtils.afterNow;
import static cn.wp.hpc.framework.common.util.date.LocalDateTimeUtils.beforeNow;
import static cn.wp.hpc.module.promotion.enums.ErrorCodeConstants.*;
import static cn.wp.hpc.module.promotion.enums.MessageTemplateConstants.COMBINATION_SUCCESS;
