...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.wp.boot";
    private static final String ARTIFACT_ID = "hpc";
    private static final String PACKAGE_NAME = "cn.wp.hpc";
    private static final String TITLE = "HPC管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.wp.boot";
        String artifactIdNew = "hpc";
        String packageNameNew = "cn.wp.hpc";
        String titleNew = "HPC管理系统";
